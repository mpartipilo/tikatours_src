...
HTML;
    ...
    $settings_content = <<< HTML
        <table width="100%" border="0" cellspacing="0" cellpadding="8">
            <tr><td width="200">Main Category Name:</td></tr>
            <tr>
                <td colspan="3"><input name="name" type="text" id="name" value="$name" style="width:300px;" /></td>
            </tr>
            <tr><td width="200">Main Category Sub Heading:</td></tr>
            <tr>
                <td colspan="3"><input name="sub_heading" type="text" id="sub_heading" value="$sub_heading" style="width:300px;" /></td>
            </tr>
    </table>
HTML;
