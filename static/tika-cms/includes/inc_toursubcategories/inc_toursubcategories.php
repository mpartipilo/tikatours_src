...
function do_main(){
    ...
    $main_heading = 'Tour Sub Categories';
    $tbl_name     = 'tour_category';
    ...
    $active_pages  = "";
    $page_contents = "";
    $sql           = "SELECT `id`, `name`, `rank`, `status`, `parent_id`
                    FROM $tbl_name
                    WHERE `status` != 'D'
                    AND `parent_id` != 0
    ...
    while($row = mysql_fetch_assoc($result)) {
        ...
        $cat_name = fetch_value("SELECT `name` FROM $tbl_name WHERE `id` = '$parent_id' LIMIT 1");
        ...
        <table width="100%" class="bordered">
            <thead>
                <tr style="height:auto; font-weight:bold;">
                    ...
                    <th width="200" align="left">MAIN CATEGORY</th>
