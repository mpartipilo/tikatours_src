  ...
  e.supersized = function(t) {
    ...
    r._start = function() {
      ...
      if (r.options.random) {
        ...
        for (
          var n, i, s = arr.length;
          s;
          n = parseInt(Math.random() * s),
            i = arr[--s],
            arr[s] = arr[n],
            arr[n] = i
        );
    ...
    r.nextSlide = function() {
      ...
      switch (r.options.transition) {
        ...
        case 1:
        case "fade":
          i.css({ opacity: 0, visibility: "visible" }).animate(
            { opacity: 1, avoidTransforms: !1 },
        ...
        case 2:
        case "slideTop":
          i.css({ top: -r.$el.height(), visibility: "visible" }).animate(
            { top: 0, avoidTransforms: !1 },
            r.options.transition_speed,
            function() {
              r.afterAnimation()
            }
        ...
        case 3:
        case "slideRight":
          i.css({ left: r.$el.width(), visibility: "visible" }).animate(
            { left: 0, avoidTransforms: !1 },
            r.options.transition_speed,
            function() {
              r.afterAnimation()
            }
        ...
        case "carouselRight":
          ...
          n.animate(
            { left: -r.$el.width(), avoidTransforms: !1 },
            r.options.transition_speed
          )
          break
        case 7:
    ...
    _init: function() {
      ...
      e(vars.tray_button).toggle(
        function() {
          e(vars.thumb_tray)
            .stop()
            .animate({ bottom: 0, avoidTransforms: !0 }, 300)
        ...
        function() {
          e(vars.thumb_tray)
            .stop()
            .animate(
              { bottom: -e(vars.thumb_tray).height(), avoidTransforms: !0 },
              300
            )
          e(vars.tray_arrow).attr("src") &&
            e(vars.tray_arrow).attr(
          ...
          if (r > n) {
            ...
            if (s > 10 || s < -10) {
              ...
              e(vars.thumb_list)
                ...
                .animate(
                  { left: newX },
                  { duration: s * 3, easing: "easeOutExpo" }
                )
            }
          }
        })
